...
if __name__ == '__main__':
    wm = WM(DNA_size=DNA_SIZE, DNA_bound=ASCII_BOUND, cross_rate=CROSS_RATE,
            mutation_rate=MUTATION_RATE, pop_size=POP_SIZE)

    for generation in range(N_GENERATIONS):
        fitness = wm.get_fitness()
        best_DNA = wm.pop[np.argmax(fitness)]
        best_phrase = wm.translateDNA(best_DNA)
